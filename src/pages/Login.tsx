    ...
    try {
      if (isSignUp) {
        ...
        toast({
          ...
          description: "Welcome to BoardBrief.",
        });
        navigate("/app/home");
      } else {
      ...
      <div className="flex flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="mx-auto w-full max-w-sm">
          ...
          <Link to="/" className="flex items-center justify-center gap-2 mb-8">
            ...
            <span className="text-xl font-semibold text-foreground">BoardBrief</span>
          </Link>
          ...
          <p className="text-center text-sm text-muted-foreground mb-8">
            {isSignUp
              ? "Start organizing your game nights today"
              : "Sign in to continue to BoardBrief"}
          </p>
      ...
      <div className="hidden lg:flex lg:flex-1 bg-secondary items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <p className="text-muted-foreground">
            Rules lookups, game night planning, and tournament tracking — all in one place.
          </p>
        </div>
      </div>
    </div>
